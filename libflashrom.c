...
{
  /* TODO: Shut down libflashrom, close devices or files, free all resources, etc. */
...
{
	int i = 0;
  flashrom_flashchip_info *supported_flashchips = NULL;
	supported_flashchips = malloc(flashchips_size * sizeof(supported_flashchips));
